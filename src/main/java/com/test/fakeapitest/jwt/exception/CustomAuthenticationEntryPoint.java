...
public class CustomAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    // Spring Security 는 인증 인가 실패 시 FilterSecurityInterceptor가 2가지 예외를 발생
    // 인증 예외 발생 시 AuthenticationException 호출
    // AuthenticationException 은 AuthenticationEntryPoint 인터페이스로 커스터마이징 가능
    ...
    public void setResponse(HttpServletResponse response, JwtExceptionCode exceptionCode) throws IOException{
